    ...
    <div class="container-fluid">
      ...
      <div class="card card-body blur shadow-blur mx-4 mt-n6">
        ...
        <!-- <div class="col-auto"> -->
          ...
          <div class="col-auto my-auto" align="center">
            <div class="h-100">
              <h5 class="mb-1">
                Alec Thompson
              </h5>
              <p class="mb-0 font-weight-bold text-sm" align="center">
                CEO / Co-Founder
              </p>
            </div>
          </div>
            ...
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item active">
                  <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="#my-profile" role="tab" aria-controls="my-profile" aria-selected="true">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#edit-profile;" role="tab" aria-controls="edit_profile" aria-selected="true">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="#change-password;" role="tab" aria-controls="change_password" aria-selected="true">
...
<!-- End Konten Profile Information -->
